...
full_data = pd.read_csv("/data/shruti/ONR/small_data/caa_complete_unclean_data.csv", header=0)
...
textgroups.to_csv("/data/shruti/ONR/small_data/caa_pythonwrapper_outout.csv")
